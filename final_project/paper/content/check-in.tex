...
\subsection*{Updates based on feedback from Project Proposal Evaluation} The paper now has a more focused scope, concentrating on how generative AI tools reshape developer problem-solving strategies across different stages of software development. The introduction has been revised to reflect this focus, emphasizing the cognitive and behavioral shifts induced by AI assistance. The title has been updated to \textbf{"From Exploration to Acceleration: How Generative AI Reshapes Development Practices"} to better capture the essence of the paper's focus on the transformation of development practices through generative AI.
...
(\textit{Discussed in the paper below, in detail}) Summary: The motivation for this paper arises from the rapid integration of generative AI tools into software development and the need to understand their impact on developers’ problem-solving strategies. While these tools are often associated with productivity gains, there is limited understanding of how they influence developer cognition and workflows. This paper addresses this gap by presenting a structured literature survey that examines how generative AI affects different stages of problem-solving, moving beyond a productivity-centric view to analyze its role in shaping developer behavior and decision-making.

\subsection*{Literature Review Process and Timeline}

For this literature survey, I followed a structured process to identify and curate relevant papers on generative AI in software engineering. I primarily searched digital libraries such as Google Scholar, ACM Digital Library, and arXiv using keywords related to generative AI, code generation, and developer interaction. The selection process involved filtering for recent, high-impact, and empirical studies, followed by iterative refinement to ensure diversity in perspectives while maintaining a manageable scope of ten papers. The timeline for this process was spread across the initial weeks of the project, with the first phase dedicated to paper discovery, followed by reading, note-taking, and organizing themes for synthesis.

\subsection*{Evaluation of Success}
The success of this project will be evaluated based on the clarity, depth, and structure of the synthesized insights. Specifically, I aim to demonstrate success by
\begin{itemize}
    \item Presenting a well-defined taxonomy of AI-assisted programming interactions
    \item Effectively mapping these interactions to different stages of the development lifecycle.
    \item Coherent integration of findings across papers, identification of consistent patterns and gaps
    \item Ability to provide meaningful insights beyond individual paper summaries
\end{itemize}
Additionally, the overall organization, readability, and alignment with the research question will serve as indicators of the project's effectiveness.
